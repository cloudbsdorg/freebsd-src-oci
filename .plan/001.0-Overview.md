...
**Date:** 2026-04-25  
**Last status reconciliation:** 2026-07-21  
**Repository:** https://github.com/cloudbsdorg/freebsd-src-oci  
**Active implementation branch:** `feature/oci-bootstrap`  
**Docs / upstream-tracking branch:** `main` (has `.plan/` + `release/Makefile.oci`; does **not** yet contain `usr.sbin/ocifbsd/`)

> **Status (2026-07-22):** Design remains as below. Implementation bootstrap is **build-complete** on `feature/oci-bootstrap` (all 15 SUBDIRs compile on FreeBSD 16; 42 convert unit tests pass). That is **not** product-complete. **Execution authority:** [`021.0-Consolidated-Execution-Plan.md`](./021.0-Consolidated-Execution-Plan.md) (FreeBSD-first, Honcho, red–green, lab). Task tracker: [`005.0-Risks-TODO.md`](./005.0-Risks-TODO.md) §0. This is FreeBSD `src` — prefer additive `usr.sbin/ocifbsd/`; follow style(9); consult Honcho before/after work.
